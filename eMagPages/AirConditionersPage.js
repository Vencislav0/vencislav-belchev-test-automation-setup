...
class AirConditioningPage extends BaseForm {
  constructor() {
    super('//div[@class="page-container"]', 'Air Conditioners Page Container')
    this.titles = []
    this.prices = []
    ...
    this.daikinCheckBox = new CheckBox('//a[@data-name="Daikin" and @data-position="popup"]', 'Daikin Option CheckBox')
  ...
  async checkDaikinCheckbox() {
    await this.daikinCheckBox.check()
  }
  ...
  async clickFilterButton() {
    ...
    await browser.waitUntil(
      async () => {
        return (await browser.getUrl()).includes('daikin')
      },
  ...
  async sortPriceInDescendingOrder() {
    ...
    await browser.waitUntil(
      async () => {
        return (await browser.getUrl()) === 'https://www.emag.bg/klimatici/brand/daikin/sort-pricedesc/c'
      },
...
module.exports = AirConditioningPage
